...
import { tee, competition } from '../index';
...
export type InsertCompForm = typeof compForm.$inferInsert
export type SelectCompForm = typeof compForm.$inferSelect
export type InsertCompFormToTee = typeof compFormToTee.$inferInsert
export type SelectCompFormToTee = typeof compFormToTee.$inferSelect
